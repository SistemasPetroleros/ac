...
?>
<script>
    function editar(idMenu, nombre, orden, icono)
    {
        $("#nombre").val(nombre);
        $("#idMenu").val(idMenu);
        $("#orden").val(orden);
        $("#icono").val(icono).change();
        if (idMenu > 0) {
            $("#eliminar").show();
        } else {
            $("#eliminar").hide();
...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Menú</h3><?= $mensaje ?>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTable1">
                    ...
                    <tbody>
                        ...
                        while ($x = mysqli_fetch_assoc($array)) {
                            $ico = str_replace('"', '\"', $x['icono']);
                            echo '<tr class="odd gradeX"><td>' . $x['id'] . '</td><td>' . $x['nombre'] . '</td><td>' . $x['orden'] . '</td><td><i class="fa ' . $x['icono'] . '" aria-hidden="true"></i></td><td style="width:100px;"><button type="button" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-dark btn-round" onclick="editar(\'' . $x['id'] . '\',\'' . $x['nombre'] . '\',\'' . $x['orden'] . '\',\'' . $ico . '\');"> Editar</button></td></tr>';
                        }
                        ?>
                ...
                <!-- /.table-responsive -->
                <div class="well">
                    <h4>Informacion sobre Menú</h4>
                    <p>Los distintos Menú agrupan links de acceso al sistema, los <a href="links.php">links</a> se relacionan con <a href="roles.php">roles</a> los que luego se deberan relacionar con cada usuario.</p>
            ...
            <form role="form" action="" method="post" id="formulario"> 
                <div class="modal-body"> 
                    ...
                    <div class="form-group"> 
                        ...
                        <select class="form-control" name="icono" id="icono" data-live-search="true" >
                ...
                <div class="modal-footer"> 
                    <div id="eliminar">
                        ...
                        <button type="button" class="btn btn-danger pull-left btn-round" name="eliminar" onclick="guardarForm('menu.php', 'formulario', 'eliminar');">Eliminar</button>
                    </div>
                    ...
                    <button type="button" class="btn btn-dark btn-round" name="guardar" onclick="guardarForm('menu.php', 'formulario');">Guardar</button> 
                </div> 
            </form> 
        </div>
    </div>
