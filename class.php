...
class ab_manualdat
{
	...
	*/
	...
	{
		Global $dblink;
		$query = "SELECT md.troquel,md.nombre,md.presentacion,md.precio,md.fecha, md.codbarra, md.unidades, me.coddroga, mo.descripcion as droga, md.nroregistro FROM ab_manualdat md
left join ab_manextra me on me.nroregistro=md.nroregistro
left join ab_monodro mo on mo.codigo=me.coddroga
...
/******************************************************************************
* Class for farmacia.usuarios_proveedor
*******************************************************************************/

class usuarios_proveedor
{
	/**
	* @var int
	*/
	...
	*/
	...
	{
		Global $dblink;
		$query ="INSERT INTO usuarios_proveedor (`id_proveedor`,`id_usuarios`) VALUES ('" . mysqli_real_escape_string($dblink,$this->getid_proveedor()) . "','" . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . "');";
		mysqli_query($dblink,$query);
	...
	{
		Global $dblink;
		$query ="delete from usuarios_proveedor where id_proveedor='" . mysqli_real_escape_string($dblink,$this->getid_proveedor()) . "' and id_usuarios = '" . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . "';";
		mysqli_query($dblink,$query);
	...
	{
		Global $dblink;
		$query ="INSERT INTO usuarios_proveedor (`id_proveedor`,`id_usuarios`) VALUES ('" . mysqli_real_escape_string($dblink,$this->getid_proveedor()) . "','" . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . "') ON DUPLICATE KEY UPDATE ;";
		mysqli_query($dblink,$query);
	...
	{
		Global $dblink;
		$query = "SELECT * FROM proveedores where id in (select distinct id_proveedor from usuarios_proveedor where id_usuarios= " . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . ") ";
	...
	{
		Global $dblink;
		$query = "SELECT * FROM proveedores where id not in (select distinct id_proveedor from usuarios_proveedor where id_usuarios= " . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . ") ";
...
} // END class usuarios_proveedor




/******************************************************************************
* Class for farmacia.usuarios_ptosdispensa
*******************************************************************************/

class usuarios_ptosdispensa
{
	/**
	* @var int
	*/
	private $id_ptoDispensa;
	...
	*/
	...
	{
		Global $dblink;
		$query ="INSERT INTO usuarios_ptosdispensa (`id_ptoDispensa`,`id_usuarios`) VALUES ('" . mysqli_real_escape_string($dblink,$this->getid_ptoDispensa()) . "','" . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . "');";
		mysqli_query($dblink,$query);
	...
	{
		Global $dblink;
		$query ="delete from usuarios_ptosdispensa where id_ptoDispensa='" . mysqli_real_escape_string($dblink,$this->getid_ptoDispensa()) . "' and id_usuarios = '" . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . "';";
		mysqli_query($dblink,$query);
	...
	{
		Global $dblink;
		$query ="INSERT INTO usuarios_ptosdispensa (`id_ptoDispensa`,`id_usuarios`) VALUES ('" . mysqli_real_escape_string($dblink,$this->getid_ptoDispensa()) . "','" . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . "') ON DUPLICATE KEY UPDATE ;";
		mysqli_query($dblink,$query);
	...
	{
		Global $dblink;
		$query = "SELECT * FROM puntos_dispensa where id in (select distinct id_ptoDispensa from usuarios_ptosdispensa where id_usuarios= " . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . ") ";
	...
	{
		Global $dblink;
		$query = "SELECT * FROM puntos_dispensa where id not in (select distinct id_ptoDispensa from usuarios_ptosdispensa where id_usuarios= " . mysqli_real_escape_string($dblink,$this->getid_usuarios()) . ") ";
	...
	public function setid_ptoDispensa($id_ptoDispensa='')
	{
		$this->id_ptoDispensa = $id_ptoDispensa;
		return true;
	}

	public function getid_ptoDispensa()
	{
		return $this->id_ptoDispensa;
	}
