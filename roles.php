...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Roles</h3><?= $mensaje ?>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <table width="100%" class="table jambo_table" id="dataTable1">
                    ...
                    <tbody>
                        ...
                        while ($x = mysqli_fetch_assoc($array)) {
                            ...
                            echo '<tr class="odd gradeX"><td>' . $x['id'] . '</td><td>' . $x['nombre'] . '</td><td>' . $x['descripcion'] . '</td><td><button type="button" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-dark btn-round" onclick="editar(\'' . $x['id'] . '\',\'' . $x['nombre'] . '\',\'' . $x['descripcion'] . '\');"> Editar</button>&nbsp;&nbsp;<a href="#" class="btn btn-dark btn-round" onclick="menu(\'roles_links.php?idRoles=' . $x['id'] . '\', \'Link x Rol\', \'236\',0); return false;">Links</a></td></tr>';
                        }
                        ?>
        ...
        <div class="modal-content"> 
            ...
            <form role="form" action="" method="post" id="formulario"> 
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger pull-left btn-round" name="eliminar" onclick="guardarForm('roles.php', 'formulario', 'eliminar');">Eliminar</button>
                    </div>
                    ...
                    <button type="button" class="btn btn-dark btn-round" name="guardar" onclick="guardarForm('roles.php', 'formulario');">Guardar</button> 
                </div> 
            </form> 
        </div>
    </div>
