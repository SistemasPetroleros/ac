    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Asignacion de Puntos de dispensa a Usuarios. 
...
$usuarios_ptoDispensa=new usuarios_ptosdispensa();
$usuarios_ptoDispensa->setid_usuarios($_GET['idUsuarioRoles']);
if ($usuarios_ptoDispensa->getid_usuarios()>0){
if(isset($_GET['idRolAgregar'])){
    $usuarios_ptoDispensa->setid_ptoDispensa($_GET['idRolAgregar']);
    $usuarios_ptoDispensa->Create();        
}
if(isset($_GET['idRolQuitar'])){
    $usuarios_ptoDispensa->setid_ptoDispensa($_GET['idRolQuitar']);
    $usuarios_ptoDispensa->Delete();        
}

?>
<div class="col-md-4">        
        <table width="100%" class="table jambo_table">
            <tr><th>Puntos Dispensa Disponibles</th><th></th></tr>
<?php

$array=$usuarios_ptoDispensa->SelectAllNoRelacionados();
    ...
    while ($x = mysqli_fetch_assoc($array)) 
    {
        ...
        echo '<tr><td>'.$x['nombre'].' ('.($tipo).')</td><td align="right"><a href="#" class="btn btn-dark btn-round"  onclick="menu(\'usuarios_ptosdispensa.php?idUsuarioRoles='.$_GET['idUsuarioRoles'].'&idRolAgregar='.$x['id'].'\', \'' . $x['nombre'] . '\', \'242\',0); return false;"> > </a></td></tr>';
    }
...
<div class="col-md-4">        
        <table width="100%" class="table jambo_table">
            <tr><th>Puntos Dispensa Autorizados</th><th></th></tr>
<?php    
    $array=$usuarios_ptoDispensa->SelectAllRelacionados();
    ...
    while ($x = mysqli_fetch_assoc($array)) 
    {
        ...
        echo '<tr><td><a href="#" class="btn btn-dark btn-round"  onclick="menu(\'usuarios_ptosdispensa.php?idUsuarioRoles='.$_GET['idUsuarioRoles'].'&idRolQuitar='.$x['id'].'\', \'' . $x['nombre'] . '\', \'242\',0); return false;"> < </a></td><td>'.$x['nombre'].' ('.($tipo).')</td></tr>';
    }
...
<div class="col-md-12"><br><br><br><br><br></div>                
                ...
                <div class="well col-md-12" >
                    <h4>Puntos de dispensa que puede registrar o ver un usuario</h4>
