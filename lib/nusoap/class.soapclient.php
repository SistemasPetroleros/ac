...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 30, $response_timeout = 60, $portName = ''){
		parent::nusoap_base();
