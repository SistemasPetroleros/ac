...
class materiales_solicitudes
{
	...
	{
		global $dblink;
		$query = "INSERT INTO materiales_solicitudes (`id_personas`,`fecha`,`observaciones`,`id_puntos_dispensa`, `esSur`) VALUES ('" . mysqli_real_escape_string($dblink, $this->getid_personas()) . "',now(),'" . mysqli_real_escape_string($dblink, $this->getobservaciones()) . "','" . mysqli_real_escape_string($dblink, $this->getid_puntos_dispensa()) . "','" . mysqli_real_escape_string($dblink, $this->getesSur()) . "');";
		mysqli_query($dblink, $query);
