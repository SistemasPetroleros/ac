...
class usuario_tipo_solicitud
{
	...
	*/
	...
	{
		Global $dblink;
		$query = "SELECT * FROM estados where id in (select distinct idTipoSolicitud from usuario_tipo_solicitud where idUsuario= " . mysqli_real_escape_string($dblink,$this->getidUsuario()) . ") ";
	...
	{
		Global $dblink;
		$query = "SELECT * FROM estados where id not in (select distinct idTipoSolicitud from usuario_tipo_solicitud where idUsuario= " . mysqli_real_escape_string($dblink,$this->getidUsuario()) . ") ";
		$result = mysqli_query($dblink,$query);
