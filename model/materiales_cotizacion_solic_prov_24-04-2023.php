...
class materiales_cotizacion_solic_prov
{
	...
	*/
	...
	{
        Global $dblink;
		$query ="INSERT INTO materiales_cotizacion_solic_prov (`id_proveedores`,`id_solicitudes`,`userAlta`) VALUES ('" . mysqli_real_escape_string($dblink,$this->getid_proveedores()) . "','" . mysqli_real_escape_string($dblink,$this->getid_solicitudes()) . "','" . mysqli_real_escape_string($dblink,$this->getuserAlta()) . "');";
		//echo $query;
