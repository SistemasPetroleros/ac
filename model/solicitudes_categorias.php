...
class solicitudes_categorias
{
	...
	*/
	...
	{
		Global $dblink;
		$query = "SELECT * FROM solicitudes_categorias WHERE `id`='{$this->getid()}'";
	...
	{
		Global $dblink;
		$query = "SELECT * FROM solicitudes_categorias ";
	...
	{
		Global $dblink;
		$query = "UPDATE solicitudes_categorias SET 
	...
	{
		Global $dblink;
		$query ="INSERT INTO solicitudes_categorias (`nombre`,`userAlta`) VALUES ('" . mysqli_real_escape_string($dblink,$this->getnombre()) . "','".$_SESSION["user"]."');";
		mysqli_query($dblink,$query);
	...
	{
		Global $dblink;
		$query = "DELETE FROM solicitudes_categorias
						WHERE `id`='{$this->getid()}'";
