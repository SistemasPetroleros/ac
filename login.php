...
function ScriptActual2(){
    $script = basename($_SERVER['PHP_SELF']);
	
    return $script;
}
function ScriptActual3(){
    $script = $_SERVER['PHP_SELF'];
    $string_a_quitar = "/actest/";
    $script = str_replace($string_a_quitar, "", $script);
...
if ($u->getid() > 0) {
  ...
  /* 
    ...
    if (!$u->VerificaLink(ScriptActual2()) > 0 or !$u->getuser() == 'administrador') {
...
/*echo '<br>ScriptActual2():'.ScriptActual2().'<br>';
echo '<br>ScriptActual3():'.ScriptActual3().'<br>';

echo '<br>$u->VerificaLink(ScriptActual2()):'.$u->VerificaLink(ScriptActual2()).'<br>';
echo '<br>$u->VerificaLink(ScriptActual3()):'.$u->VerificaLink(ScriptActual3()).'<br>';*/

    /*if($u->getuser() != 'administrador'){
        if($u->VerificaLink(ScriptActual2()) == 0){
            if($u->VerificaLink(ScriptActual3()) == 0){
                echo 'Script no configurado';
                exit();
            }
        }
        ...
        if($u->VerificaLink(ScriptActual2()) == 0){
            ...
            else if(ScriptActual2()=="login.php" OR ScriptActual3()=="login.php") echo '<script> window.location.href="index.php";</script>';
        }
        else if(ScriptActual2()=="login.php" OR ScriptActual3()=="login.php") echo '<script> window.location.href="index.php";</script>';
        
    }else{
        if(ScriptActual2()=="login.php" OR ScriptActual3()=="login.php") echo '<script> window.location.href="index.php";</script>';
    }
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="login-panel panel panel-default">
                            <div class="panel-heading">
                                <img src="img/02.png" style="height:50px; ">
                            ...
                            <div class="panel-body">
                                <form role="form"  method="post" action="index.php">
                                    <fieldset>
                                        ...
                                        <button type="submit" class="btn btn-lg btn-dark btn-block">Ingresar</button>
