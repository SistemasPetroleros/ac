...
while ($x = mysqli_fetch_assoc($array)) {
    ...
    echo '<tr class="odd gradeX"><td>' . $x['id'] . '</td><td>' . $x['nombre'] . '</td><td>' . $x['apellido'] . '</td><td>' . $x['user'] . '</td><td>' . $vend . '</td><td>' . $habi . '</td><td style="width:300px;"><button type="button" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-dark btn-round" onclick="editar(\'' . $x['id'] . '\',\'' . $x['apellido'] . '\',\'' . $x['nombre'] . '\',\'' . $x['user'] . '\',\'' . $x['pass'] . '\',\'' . $x['vendedor'] . '\',\'' . $x['habilitado'] . '\');"> Editar</button>&nbsp;&nbsp;<a href="#" class="btn btn-dark btn-round" onclick="menu(\'usuarios_roles.php?idUsuarioRoles=' . $x['id'] . '\', \'\', \'242\',0); return false;">Roles</a>&nbsp;&nbsp;<a href="#" class="btn btn-dark btn-round" onclick="menu(\'usuarios_estados.php?idUsuarioRoles=' . $x['id'] . '\', \'\', \'242\',0); return false;">Estados</a>&nbsp;&nbsp;<a href="#" class="btn btn-dark btn-round" onclick="menu(\'usuarios_ptosdispensa.php?idUsuarioRoles=' . $x['id'] . '\', \'\', \'242\',0); return false;">Ptos. Dispensa</a>&nbsp;&nbsp;<a href="#" class="btn btn-dark btn-round" onclick="menu(\'usuarios_proveedores.php?idUsuarioRoles=' . $x['id'] . '\', \'\', \'242\',0); return false;">Proveedores</a>&nbsp;&nbsp;<a href="#" class="btn btn-dark btn-round" onclick="menu(\'usuarios_tipoSolicitud.php?idUsuarioRoles=' . $x['id'] . '\', \'\', \'242\',0); return false;">Tipos Solicitud</a></td></tr>';
}
?>
