    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Asignacion de Proveedores a Usuarios. 
...
$usuarios_proveedor=new usuarios_proveedor();
$usuarios_proveedor->setid_usuarios($_GET['idUsuarioRoles']);
if ($usuarios_proveedor->getid_usuarios()>0){
if(isset($_GET['idRolAgregar'])){
    $usuarios_proveedor->setid_proveedor($_GET['idRolAgregar']);
    $usuarios_proveedor->Create();        
}
if(isset($_GET['idRolQuitar'])){
    $usuarios_proveedor->setid_proveedor($_GET['idRolQuitar']);
    $usuarios_proveedor->Delete();        
}

?>
<div class="col-md-4">        
        <table width="100%" class="table jambo_table">
            <tr><th>Proveedores Disponibles</th><th></th></tr>
<?php

$array=$usuarios_proveedor->SelectAllNoRelacionados();
    ...
    while ($x = mysqli_fetch_assoc($array)) 
    {
        ...
        echo '<tr><td>'.$x['nombre'].' ('.($tipo).')</td><td align="right"><a href="#" class="btn btn-dark btn-round"  onclick="menu(\'usuarios_proveedores.php?idUsuarioRoles='.$_GET['idUsuarioRoles'].'&idRolAgregar='.$x['id'].'\', \'' . $x['nombre'] . '\', \'242\',0); return false;"> > </a></td></tr>';
    }
...
<div class="col-md-4">        
        <table width="100%" class="table jambo_table">
            <tr><th>Puntos Proveedores Autorizados</th><th></th></tr>
<?php    
    $array=$usuarios_proveedor->SelectAllRelacionados();
    ...
    while ($x = mysqli_fetch_assoc($array)) 
    {
        ...
        echo '<tr><td><a href="#" class="btn btn-dark btn-round"  onclick="menu(\'usuarios_proveedores.php?idUsuarioRoles='.$_GET['idUsuarioRoles'].'&idRolQuitar='.$x['id'].'\', \'' . $x['nombre'] . '\', \'242\',0); return false;"> < </a></td><td>'.$x['nombre'].' ('.($tipo).')</td></tr>';
    }
