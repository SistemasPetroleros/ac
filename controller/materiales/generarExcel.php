    ...
    <div id="formulario" align="left">
       <table border="1">
           <thead>
                ...
                <th style="background-color:#394D5F; color: #FFFFFF; font-weight: bold; border-color: #364B5F;">Cantidad / Nombre Producto / Proveedor / Cant. Aprob. / Estado / Importe Cotizado</th>
                <th style="background-color:#394D5F; color: #FFFFFF; font-weight: bold; border-color: #364B5F;">Total Aprobado</th>
           </thead>
           <tbody>
            <?php 
