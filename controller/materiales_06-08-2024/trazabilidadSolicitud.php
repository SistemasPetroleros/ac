    ...
    if ($idEstadoActual == 7 || $idEstadoActual == 8 || $idEstadoActual == 13 || $idEstadoActual == 14 || $idEstadoActual == 15 || $idEstadoActual == 23 || $idEstadoActual == 29 || $idEstadoActual == 30) {
        ...
        <br/>';
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    $estado = '<a href="#"  onclick="abrirEstados(' . $idSolicitud . ',\'' . $row['id_item'] . '\',' . $row['id'] . ');" id="popup_msg"><u>' . $row['estado'] . '</u></a>';
        ...
        while ($rowi = mysqli_fetch_assoc($res1)) {
            ...
            $estado = '<a href="#"  onclick="abrirEstados(' . $idSolicitud . ',\'' . $rowi['id_item'] . '\',' . $rowi['id'] . ');" id="popup_msg"><u>' . $rowi['estado'] . '</u></a>';
