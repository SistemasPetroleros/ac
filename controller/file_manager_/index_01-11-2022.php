...
function agregarEstado($archivo){
	global $idSolicitud;
...
if($_GET['do'] == 'list') {
	...
	agregarEstado($_FILES['file_data']['name']);
...
<?php endif; ?>
	...
	//	console.log('Files: ', data)
		...
		var $dl_link = $('<a/>').attr('href','?do=download&file='+ encodeURIComponent(data.name))
			.addClass('download').text('Descargar');
