...
$buscarEsOnco= isset($_POST['buscarEsOnco']) ? $_POST['buscarEsOnco'] : '';
...
if(isset($_POST['buscaProducto'])){
    ...
    $arraySolicitudes = $solicitud->SelectAllFiltros($fechaDesde,$fechaHasta,$buscaProducto,$estado,$idSolicitud,$buscaBeneficiario, $buscaBeneficiarioB24,$idPuntoDispensa, $buscarNroRemito, $buscarEsSur,$buscarEsOnco);
