...
while($row=mysqli_fetch_assoc($resultado)){
    ...
    $tbody.="<tr>";
    if($idEstado=="17" or $idEstado==25 or $idEstado == "16"){
    ...
    $tbody.='<td> 
     <a href="#" onclick="abrirEstados('.$idSolicitud.',\''.$row['id_item'].'\','.$row['id'].');" id="popup_msg"><u><span class="badge badge-info">'.$row['estado'].'</span></u></a> 
