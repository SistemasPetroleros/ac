            ...
            $tabla .= '
                    <div class="form-group">
                        <div class="col-sm-6">
                            ...
                            <button type="button" class="btn btn-success btn-round" onclick="informarSeleccionadosNC();"><i class="fa fa-check" aria-hidden="true"></i> Informar Seleccionados</button>
                        </div>
                    </div>';
        }
        $tabla .= '
