    ...
    if ($row = mysqli_fetch_assoc($resultadoTraza)) {
        ...
        if ($oSoap->fault) {
            ...
            $param = "  <arg0>" . $idTransaccion . "</arg0>
                  <arg1>" . $user . "</arg1>
                  <arg2>" . $pass . "</arg2>
                  <arg3>" . $row['gtin'] . "</arg3><!-- Gtin-->
                  <arg4>" . $row['nroSerie'] . "</arg4><!-- Serie-->";
            ...
            $result = $oSoap->call('sendCancelacTransaccParcial', $param);
            ...
            if ($oSoap->fault) {
                ...
                if ($err) {        // Muestra el error
                    ...
                    //LOG	
                    $file = fopen("logAnulaciones.txt", "a");
                    $entradaFile = "RESULTADO ANULACION RECEPCION:" . date('Y-m-d H:i:s') . " - " . $result['resultado'] . "\n" . "ID ASOCIADO:" . $result['codigoTransaccion'] . "\n\n--------------------\n\n";
