...
if(esMiembro($tipo,$permisos) and    ( ($tipo==1 and  $estadoActual=='9'  )  or ($tipo==2 and ($estadoActual=='1' or $estadoActual=='3' or $estadoActual=='9')   ) or ($tipo==3 and ($estadoActual=='2')) or ($tipo==4 and ($estadoActual=='2')) or ($tipo==6 and ($estadoActual=='5')) or ($tipo==7 and ($estadoActual=='6')) or ($tipo==8 and ($estadoActual=='7')) or ($tipo==9 and ($estadoActual=='1' or $estadoActual=='2' or $estadoActual=='4' or $estadoActual=='6' or $estadoActual=='7'))   ))
{   
