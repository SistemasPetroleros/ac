...
if ($idSolicitud > 0) {
    ...
    if ($x = mysqli_fetch_assoc($lastStatus)) {
        ...
        if ($x['id_estados'] > 31) {
            ...
            //  print_r($permisos);
            if ($idSolicitud > 1343) //ultimo id de la actualziacion del 03-05-2023 (no cambiar!!! se pincha las solicitudes menores a ese id.)
                include_once '../../view/materiales/listarProveedores.php';
            else
                include_once '../../view/materiales/listarProveedores_versionold.php';
        } else {
