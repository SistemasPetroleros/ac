...
if ($data['idTipoSolicitud'] == 2 or $data['idTipoSolicitud'] == 3) {
    ...
    $res = $item->getItemsCotizacion($data['idSolicitud'], $data['idProveedor']);
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($resultado) {
            ...
            if ($tipo == 'P' && $exito == true) {
                ...
                $estadoCot->setobservaciones('Cambio de estado Cotizacion #'.$data['idCotizacion'].' de la solicitud #' . $data['idSolicitud'] . ' a PENDIENTE AUTORIZACION.<br/> <b>MOTIVO:</b>Realizado por proveedor.');
                $estadoCot->Create();
