...
if(esMiembro("6",$permisos) and  ($estadoActual=='5'))
{
...
if(esMiembro("8",$permisos) and  ($estadoActual=='7'))
{
  ...
  //echo ' <button id="solicitarAut8" onclick="abrirModalEstadosSolicitud(\'8\','.$idSolicitud.');" type="button" data-toggle="modal" data-target="#modalComentariosSolicitud" class="btn btn-warning btn-round" title="Dispensar Pedido"><span class="fa fa-calendar-check-o"></span> Dispensar Pedido</button>';
}
...
if(esMiembro("23",$permisos) and   ($estadoActual=='15'  )) //or $estadoActual=='6' or $estadoActual=='7'
{
