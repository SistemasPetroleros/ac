                ...
                <table width="100%" class="table jambo_table" id="dataTable1">
                    ...
                    <tbody>
                        ...
                        while ($x = mysqli_fetch_assoc($array)) {
                            ...
                            echo '<tr class="odd gradeX"><td>' . $x['id'] . '</td><td>' . ($x['nombre']) . '</td><td>' . $x['cuit'] . '</td><td>' . $x['domicilio'] . '</td><td>' . $x['telefonos'] . '</td><td>' . $x['email'] . '</td><td>' . ($x['localidad']) . '</td><td>' . ($x['provincia']) . '</td><td>' . $habi . '</td><td style="width:100px;">';
                            
                            echo '<button type="button" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-dark btn-round" onclick="editar(\'' . $x['id'] . '\',\'' . ($x['nombre']) . '\',\'' . $x['cuit'] . '\',\'' . $x['domicilio'] . '\',\'' . $x['telefonos'] . '\',\'' . $x['email'] . '\',\'' . $x['id_localidades'] . '\',\'' . $x['id_provincia'] . '\',\'' . fecha4($x['fechaAlta']). '\',\'' . $x['userAlta'] . '\',\'' . fecha4($x['fechaModif']). '\',\'' . $x['userModif']. '\',\'' .$x['habilitado'] . '\');"> Editar</button>';
