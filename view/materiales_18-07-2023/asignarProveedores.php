...
$array = $obj->SelectAllNoAsignados($idSolicitud);
    ...
    while ($x = mysqli_fetch_assoc($array)) {
        ...
        . '<form class="form-inline" method="get" id="formulario' . $x['id'] . '">
            ...
            <button type="button" class="btn btn-dark btn-round" onclick="guardarGrilla(\'controller/materiales/asignarProveedores.php\', \'formulario' . $x['id'] . '\', \'agregar\', \'GET\');"> > </button> 
            </form></td></tr>';
    }
    ?>
</table>
  ...
  $array = $obj->SelectAllAsignados($idSolicitud);
    ...
    while ($x = mysqli_fetch_assoc($array)) 
    {
        ...
        . '<form class="form-inline" method="get" id="formularioq' . $x['id'] . '">
            ...
            <button type="button" class="btn btn-dark btn-round" onclick="guardarGrilla(\'controller/materiales/asignarProveedores.php\', \'formularioq' . $x['id'] . '\', \'quitar\', \'GET\');"> < </button> 
