  ...
  <div class="col-md-12">
    <table width="100%" class="table jambo_table">
      ...
      <tbody>
        ...
        $disabled = "";
        if ($estadoActual > 34 and $estadoActual < 37) {
          $disabled = 'disabled';
        }
        ...
        while ($x = mysqli_fetch_assoc($res)) {
          ...
          if ($estadoActual == 34 and $tieneAcceso) { //En PROCESO DE COTIZACION y el usuario con permiso de modificacion en este estado
      ...
      <small>* Estos datos fueron cargados en versión anterior del Sistema.</small>
