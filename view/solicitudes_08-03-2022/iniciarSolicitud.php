<div class="col-sm-4">
    ...
    <form role="form" action="" method="post" id="formulario">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="apellido" id="apellido" value="<?=$persona->getapellido()?>" required=""
                disabled>
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="nombre" name="nombre" type="text" value="<?=$persona->getnombre()?>"
                required="" disabled>
...
<div class="col-sm-4">
    ...
    <div class="col-sm-8">
            ...
            <input class="form-control" name="estadoSIA" id="estadoSIA"
                value="<?=(($persona->getestadoSIA()=='A')?'Activo':'Inactivo')?>" disabled>
                        ...
                        <div class="form-group">
                            <label for="b24" class="control-label">B24<input class="form-control" name="b24"
                                    type="checkbox" id="b24" <?=(($esB24==1 or $solicitud->getesB24()==1)?' checked ':'')?>></label>
        ...
        if($idEstado <= 1 or $idEstado==3 or $idEstado==9){
            ...
            if($activo!='A'){echo "<script>notificar('Estado de Beneficiario no valido en SIA, no es posible continuar.');</script>";}
        }
...
if($solicitud->getid()>0){
    ...
    echo '<p>Solicitud Nro: '.$solicitud->getid().'</p>';
