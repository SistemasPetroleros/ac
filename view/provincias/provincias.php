...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Provincias</h3><?= $mensaje ?>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
            ...
            <form role="form" action="" method="post" id="formulario"> 
                ...
                <div class="modal-footer">
                    <div id="eliminar">
                        ...
                        <button type="button" class="btn btn-danger pull-left btn-round" name="eliminar" onclick="guardarForm('controller/provincias/provincias.php', 'formulario', 'eliminar');">Eliminar</button>
                    </div>
                    ...
                    <button type="button" class="btn btn-dark btn-round" onclick="guardarForm('controller/provincias/provincias.php', 'formulario');" name="guardar">Guardar</button> 
                </div> 
               </div> 
            </form> 
        </div>
...
<script src="view/provincias/provincias.js"></script>