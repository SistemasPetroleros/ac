...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Localidades</h3><?= $mensaje ?>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <table width="100%" class="table jambo_table" id="dataTable1">
                    ...
                    <tbody>
                        ...
                        while ($x = mysqli_fetch_assoc($array)) {
                            ...
                            echo '<tr class="odd gradeX"><td>' . $x['id'] . '</td><td>' . $x['nombre'] . '</td><td>' . $x['provincia'] . '</td><td style="width:100px;">';
                            
                            echo '<button type="button" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-dark btn-round" onclick="editar(\'' . $x['id'] . '\',\'' . $x['nombre'] . '\',\'' . $x['id_provincia'] . '\',\'' . fecha4($x['fechaAlta']). '\',\'' . $x['userAlta'] . '\',\'' . fecha4($x['fechaModif']). '\',\'' . $x['userModif'] . '\');"> Editar</button>';
            ...
            <form role="form" action="" method="post" id="formulario"> 
                ...
                <div class="modal-footer">
                    <div id="eliminar">
                        ...
                        <button type="button" class="btn btn-danger pull-left btn-round" name="eliminar" onclick="guardarForm('controller/localidades/localidades.php', 'formulario', 'eliminar');">Eliminar</button>
                    </div>
                    ...
                    <button type="button" class="btn btn-dark btn-round" onclick="guardarForm('controller/localidades/localidades.php', 'formulario');" name="guardar">Guardar</button> 
                </div> 
               </div> 
            </form> 
        </div>
...
<script src="view/localidades/localidades.js"></script>