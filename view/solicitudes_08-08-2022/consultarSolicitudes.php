                ...
                <form method="post" id="formulario">
                    <table style="border-spacing: 10px 5px; border-collapse: separate;">
                        ...
                        ?>
                            ...
                            <tr> 
                                 <td><label for="esB24" class="control-label">Código B24</label> </td>
                                 <td><input type="text" class="form-control" id="buscaBeneficiarioB24" name="buscaBeneficiarioB24" placeholder="Código " value="">
                                </td>
            ...
            <div class="panel-body">
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="active" id="solicitudTab"><a href="#solicitud" aria-controls="solicitud" role="tab"
                                data-toggle="tab">Solicitud</a></li>
                        <li class="disabledTab" role="presentation" id="itemsTab"><a href="#items" aria-controls="items" role="tab"
                                data-toggle="tab" id="pestItems"> Items</a></li>
                        <li class="disabledTab" role="presentation" id="proveedoresTab"><a href="#proveedores" aria-controls="proveedores" role="tab"
                                data-toggle="tab">Proveedores</a></li>
                        <li class="disabledTab" role="presentation" id="adjuntosTab"><a href="#adjuntos" aria-controls="adjuntos" role="tab"
                                data-toggle="tab">Adjuntos</a></li>
                        <li class="disabledTab" role="presentation" id="estadoTab"><a href="#estado" aria-controls="estado" role="tab"
                                data-toggle="tab">Estado</a></li>
                        <li class="disabledTab" role="presentation" id="recepcionTab"><a href="#recepcionTraza" aria-controls="recepcionTraza" role="tab"
