...
function abrirModalEstadosSolicitud(idEstado, idSolicitud) {
    ...
    if (idEstado == "2") {
        ...
        document.getElementById('mensajeEstados').innerHTML = '<div class="alert   btn-dark" role="alert"> ' +
            ...
            'Ingrese una Observación de ser necesaria. La solciitud pasará a estado OBSERVADO POR AUDITORIA.' +
            '</div>';
    }
    else if (idEstado == "27") {
        document.getElementById('mensajeEstados').innerHTML = '<div class="alert   btn-dark" role="alert"> ' +
...
function onChangeStatusSolicitud() {
    ...
    if ((nuevoEstado == 'obs' && observacion.length > 0) || nuevoEstado == '2' || nuevoEstado == '3' || nuevoEstado == '4' || nuevoEstado == '6' || nuevoEstado == '7' || nuevoEstado == '8' || nuevoEstado == '9' || nuevoEstado == '1' || nuevoEstado == '13' || nuevoEstado == '14' || nuevoEstado == '15' || nuevoEstado == '23' || nuevoEstado == '26' || nuevoEstado == '27' ) { //([2, 3, 4, 6, 7, 8, 9].includes(nuevoEstado))
        NProgress.start();
        var duracion = 20000;
        type = 'POST'
        $.ajax({
