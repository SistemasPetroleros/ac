                ...
                <form method="post" id="formulario">
                    <table style="border-spacing: 10px 5px; border-collapse: separate;">
                        ...
                        <tr>
                            ...
                            <td> <label for="buscarEsOnco" class="control-label">Es Oncológico?:</label> </td>

                            <td>
                                <select id="buscarEsOnco" name="buscarEsOnco" class="form-control">
                                    <option value="-1">Todos</option>
                                    <option value="1">Sí</option>
                                    <option value="0">No</option>
...
<script src="view/solicitudes/solicitudes.js?v=1"></script>
