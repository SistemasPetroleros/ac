...
// Verificar si se cumple la condición de tipo de solicitud y esB24
if ($solicitud->getid_tipo_solicitud() === "1" && $solicitud->getesB24() === "1") {
    $apellido = $persona->getcodigoB24();
    $nombres = "";
}
?>
...
<div class="col-sm-4">
    ...
    <form role="form" action="" method="post" id="formulario">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="apellido" id="apellido" value="<?= $apellido?>" required="" disabled>
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="nombre" name="nombre" type="text" value="<?= $nombres ?>" required="" disabled>
...
<div class="col-sm-6">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control" type="datetime-local" name="fecha_vigencia_cotiz" id="fecha_vigencia_cotiz" value="<?= (($solicitud->getfecha_vigencia_cotiz()!='' and $solicitud->getfecha_vigencia_cotiz()!=null ) ? $solicitud->getfecha_vigencia_cotiz() : date('Y-m-d H:i')) ?>" />
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            &nbsp;&nbsp;
            <br/>
            <input class="form-check-input" name="esSur" type="checkbox" id="esOncologico" <?= (($esOncologico == 1 or $solicitud->getesOncologico() == 1) ? ' checked ' : '') ?>>
            <label for="esOncologico" class="form-check-label">Es Oncológico?</label>
        </div>
    </div>
