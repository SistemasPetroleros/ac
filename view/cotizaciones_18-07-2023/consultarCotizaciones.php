            ...
            <div class="panel-heading">
                ...
                <form method="post" id="formulariocot">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <label for="buscaAfiliado" class="control-label">Afiliado</label>
                            <input type="text" class="form-control" id="buscaAfiliado" name="buscaAfiliado" placeholder="DNI, Apellido o Nombre">
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4">
                            <label for="buscaIdCotizacion" class="control-label">Id. Solicitud</label>
                            <input type="number" class="form-control" id="buscaIdCotizacion" name="buscaIdCotizacion">
                        </div>

                        <div class="col-sm-4">
                            <label for="buscaFarmacia" class="control-label">Punto Dispensa</label>
                            <input type="text" class="form-control" id="buscaFarmacia" name="buscaFarmacia" placeholder="Nombre o GLN">
                        </div>
                    ...
                    <div class="form-group">
                        <br />
                        <div class="col-sm-4" style="display: flex;justify-content: left; padding: 1em;">
                            ...
                            <button type="button" data-toggle="modal" data-target="#modalCargarCotizacion" data-backdrop="false" class="btn btn-dark btn-round pull-right" onclick="cargarCotizacion();">Nueva Solicitud</button>
