                ...
                <table width="100%" class="table jambo_table" id="dataTable1">
                    ...
                    <tbody>
                        ...
                        while ($x = mysqli_fetch_assoc($array)) {
                            ...
                            echo '<button type="button" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-dark btn-round" onclick="editar(\'' . $x['id'] . '\',\'' . ($x['nombre']) . '\',\'' . $x['cuit'] . '\',\'' . $x['domicilio'] . '\',\'' . $x['telefonos'] . '\',\'' . $x['email'] . '\',\'' . $x['id_localidades'] . '\',\'' . $x['id_provincia'] . '\',\'' . fecha4($x['fechaAlta']). '\',\'' . $x['userAlta'] . '\',\'' . fecha4($x['fechaModif']). '\',\'' . $x['userModif']. '\',\'' .$x['habilitado'] . '\',\'' .$x['tipo'] . '\');"> Editar</button>';
        ...
        <div class="modal-content"> 
            ...
            <form role="form" action="" method="post" id="formulario"> 
                <div class="modal-body"> 
                    ...
                    <div class="form-group"> 
                        <label for="tipoProv" class="control-label">Tipo</label> 
                        <select id="tipoProv" name="tipoProv" class="form-control" required="">
                            <option value="A">Alto Costo</option>
