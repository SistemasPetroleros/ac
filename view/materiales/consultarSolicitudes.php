                ...
                <form method="post" id="formulario">
                    <table style="border-spacing: 10px 5px; border-collapse: separate;">
                        ...
                        <tr>
                            ...
                            <td> <label for="buscarNroRemito" class="control-label">Cotización:</label> </td>

                            <td>
                                <select class="form-control" name="cotizacionFin" id="cotizacionFin" required="">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control selectpicker" name="buscaEstado[]" id="buscaEstado"  multiple title="Seleccione opcion(es)">
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="urgenteBuscar" class="control-label">Urgente</label>
                            </td>

                            <td>
                                <select class="form-control" name="urgenteBuscar" id="urgenteBuscar" required="">
                                    <option value="-1">Todos</option>
                        ...
                        <tr>
                            <td>
                                <label for="idCategoriaBuscar" class="control-label">Categoría</label>
                            </td>

                            <td>

                                <select class="form-control" name="idCategoriaBuscar" id="idCategoriaBuscar" required="">
                                    <option value="-1">Todas</option>
                                    <?php


                                    while ($x = mysqli_fetch_assoc($arraycategorias)) {
                                        echo '<option value="' . $x['id'] . '">' . ($x['nombre']) . '</option>';
                                    }
                                    ?>
                            ...
                            <td>
                                <label for="idTipoSBuscar" class="control-label">Tipo Solicitud</label>
                            </td>
                            ...
                            <td>
                                ...
                                <select class="form-control" name="idTipoSBuscar" id="idTipoSBuscar" required="">
                                    <option value="-1">Todos</option>
                                    <?php


                                    while ($x = mysqli_fetch_assoc($arraytiposolicitud)) {
                                        echo '<option value="' . $x['id'] . '">' . ($x['nombre']) . '</option>';
                                    }
                                    ?>
                            ...
                            <td>
                                <label for="idProveedorBuscar" class="control-label">Proveedor:</label>
                            </td>

                            <td>

                                <select class="form-control" name="idProveedorBuscar" id="idProveedorBuscar" required="">
                                    <option value="-1">Todos</option>
                                    <?php


                                    while ($x = mysqli_fetch_assoc($arrayproveedores)) {
                                        echo '<option value="' . $x['id'] . '">' . ($x['nombre']) . '</option>';
                                    }
                                    ?>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                               ...
                               <!--         <li class="disabledTab" role="presentation" id="historialTab"><a href="#historial" aria-controls="historial" role="tab" data-toggle="tab">Historial</a></li> -->
...
<div id="divModalRevEst" class="panel-body">
