...
function guardarSolicitud() {
    ...
    if (puntoDispensa > 0 && idPersona > 0) {
        ...
        $.ajax({
            ...
            async: true,
            timeout: duracion,
            data: { 'idSolicitud': idSolicitud, 'idPersona': idPersona, 'puntoDispensa': puntoDispensa, 'telefono': telefono, 'email': email, 'observaciones': observaciones, 'esSur': esSur, 'cnt': miliseg() },
            success: function (datos) {
